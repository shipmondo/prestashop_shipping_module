...
jQuery(document).ready(function ($) {
  ...
  if (shipmondoShippingModuleSettings.frontendType === 'dropdown') {
    ...
    $(document).on(
      'click',
      shipmondoBaseSelector + ' .selector_type-dropdown .service_points_list .service_point',
      function () {
    ...
    const loadGoogleMaps = function () {
      ...
      script.src =
        ...
        shipmondoShippingModuleSettings.googleMapsApiKey +
        '&loading=async&callback=googleMapsInit';
      script.async = true;
    ...
    const selectServicePointFromMarker = function (service_point_id, modal) {
      const servicePointElement = modal.find(
        '.service_points_list .service_point[data-service_point_id=' + service_point_id + ']',
      );
    ...
    const shipmondoLoadMarker = function (servicePointEl) {
      const marker = new google.maps.Marker({
        ...
        icon: {
          url:
            window.shipmondoModule.modulePath +
            '/views/img/' +
            (servicePointEl.hasClass('selected') ? 'picker_green' : 'picker_default') +
            '.png',
    ...
    $(document).on(
      'click',
      shipmondoBaseSelector + ' .selector_type-modal .service_points_list .service_point',
      function () {
